      ...
      <div style={{ flex: 1, padding: "0 16px 90px" }}>
        ...
        {tab === "home" && screen === "checkout" && vendor && (
          <>
            ...
            <input className="ff-input" style={{ marginBottom: 16 }} value={deliveryAddress} onChange={(e) => setDeliveryAddress(e.target.value)} placeholder="Same or different address" />
        ...
        {tab === "orders" && openOrder && (
          <>
            ...
            <p style={{ marginBottom: 16 }}><Badge tone={statusTone(openOrder.status)}>{STAGE_LABELS[openOrder.status] || openOrder.status}</Badge></p>
